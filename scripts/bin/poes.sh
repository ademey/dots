...
export color0=$(get_hex 'base02')
export color8=$(get_hex 'base03')
export color1=$(get_hex 'red')
export color9=$(get_hex 'red')
export color2=$(get_hex 'base0B')
export color10=$(get_hex 'base0B')
export color3=$(get_hex 'yellow')
export color11=$(get_hex 'yellow')
export color4=$(get_hex 'base0C')
export color12=$(get_hex 'base0C')
export color5=$(get_hex 'base0D')
export color13=$(get_hex 'base0D')
export color6=$(get_hex 'base0A')
export color14=$(get_hex 'base0A')
export color7=$(get_hex 'white')
export color15=$(get_hex 'white')
